...
export { default as StoreSliderProduct } from '../..\\components\\Product\\StoreSliderProduct.vue'
export { default as StoreSliderRelatedProduct } from '../..\\components\\Product\\StoreSliderRelatedProduct.vue'
export { default as SingleRestaurant } from '../..\\components\\Vendor\\SingleRestaurant.vue'
export { default as SingleVendor } from '../..\\components\\Vendor\\SingleVendor.vue'
export { default as SliderVendor } from '../..\\components\\Vendor\\SliderVendor.vue'
...
export const LazyStoreSliderProduct = import('../..\\components\\Product\\StoreSliderProduct.vue' /* webpackChunkName: "components_Product/StoreSliderProduct" */).then(c => c.default || c)
export const LazyStoreSliderRelatedProduct = import('../..\\components\\Product\\StoreSliderRelatedProduct.vue' /* webpackChunkName: "components_Product/StoreSliderRelatedProduct" */).then(c => c.default || c)
export const LazySingleRestaurant = import('../..\\components\\Vendor\\SingleRestaurant.vue' /* webpackChunkName: "components_Vendor/SingleRestaurant" */).then(c => c.default || c)
export const LazySingleVendor = import('../..\\components\\Vendor\\SingleVendor.vue' /* webpackChunkName: "components_Vendor/SingleVendor" */).then(c => c.default || c)
export const LazySliderVendor = import('../..\\components\\Vendor\\SliderVendor.vue' /* webpackChunkName: "components_Vendor/SliderVendor" */).then(c => c.default || c)
export const LazyStoreSliderVendor = import('../..\\components\\Vendor\\StoreSliderVendor.vue' /* webpackChunkName: "components_Vendor/StoreSliderVendor" */).then(c => c.default || c)
export const LazyStoreVendor = import('../..\\components\\Vendor\\StoreVendor.vue' /* webpackChunkName: "components_Vendor/StoreVendor" */).then(c => c.default || c)
