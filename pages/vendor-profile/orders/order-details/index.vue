  ...
  <section class="vendor-profile">
    <div class="container">
      <div class="row">
        <div class="col-4">
          <div class="sidebar">
            <div class="sidupgrade">
              <h3>My Profile</h3>
              <div class="upgrade">
                <img src="/images/icons/svg/icon-crown.svg" alt />
          ...
          <div class="order-detail">
            <div class="order-details-head">
              ...
              <div class="details">
                <div class="row">
                  <div class="col-9">
                    <div class="order-discrip">
                      <div class="row">
                        <div class="col-5">
                          <p>Order placed on:</p>
                        </div>
                        <div class="col-7">
                          <p class="paragraph">Apr. 4, 2020</p>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
                        ...
                        <div class="col-7">
                          <p class="paragraph">4984651984</p>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
                  ...
                  <div>
                    <b-card no-body class="overflow-hidden">
                      <b-row no-gutters>
                        ...
                        <b-col md="8">
                          <b-card-body>
                            <p class="name">Apple Watch Series 4 GPS</p>
                            <p class="seller">
                              <span>Seller:</span>
                              <span>Tom Hanks</span>
                            </p>
