        ...
        <form>
          <div class="row justify-content-around">
            ...
            <div class="form-group col-md-5">
              ...
              <select id="auccategory" class="form-control form-control-lg">
          ...
          <div class="row justify-content-around">
            <div class="form-group col-md-5">
              ...
              <b-form-datepicker style="padding: 0.5rem;  box-shadow: none;"></b-form-datepicker>
            </div>
            <div class="form-group col-md-5">
          ...
          <div class="row justify-content-around">
            <div class="form-group col-md-5">
              ...
              <b-form-timepicker style="padding: 0.5rem;  box-shadow: none;"></b-form-timepicker>
            </div>
            <div class="form-group col-md-5">
          ...
          <div class="row justify-content-around">
            <div class="form-group col-md-5">
              ...
              <div class="text-field">
                <input type="file" id="coverimage" multiple />
                ...
                <div class="col-md-3">
                 <div class="gallery-box">
                  ...
                  <img class="icon" src="/images/icons/svg/close-btn-blue.svg" alt="">
                  </div>
                </div>
          ...
          <div class="btn-section">
            <button class="auction-btn">Add Auction</button>
          </div>
        </form>
      </div>
    </div>
